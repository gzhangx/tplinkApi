...
class TplinkDecoApi:
    ...
    def _generate_aes_key_and_iv(self):
        ...
        self._aes_key = 1728043569335086;
        self._aes_iv = 1728043569335086;
    ...
    async def _async_fetch_keys(self):
        ...
        response_json = await self._async_post(
            ...
            params={"form": "keys"},
            data='operation=read' #json.dumps({"operation": "read"}),
        )
        ...
        try:            
            ...
            #self._password_rsa_n = int('C762FB52B9A847325F5EA24B1EE193DBB69BC20E97A00900E0683C4AA67E5278FBE9797FD54448711B8C3BE0428F0D93506B55D574E98B015D3431E4B06D1F9D', 16)
    ...
    async def _async_fetch_auth(self):
        ...
        try:
            auth_result = response_json["data"]
            auth_key = auth_result["key"]
            self._sign_rsa_n = int(auth_key[0], 16)
            print("got auth rsan----------------------",auth_key[0])
    ...
    def _encode_sign(self, data_len: int):
        ...
        print("self.paaaworddddddddddddddd",self._password)
        ...
        print("sign_text=",sign_text,'-------------------------------------self._sign_rsa_n')
...
if __name__ == "__main__":
    ...
    loop.run_until_complete(main1('test'))  #sys.argv[1]
    loop.close()    